  ...
  return (
      <div className="flex justify-center flex-col items-center w-full p-2 mt-8">
        ...
        <div className="">
          ...
          <p>We display all the current events happening around Stockholm. See anything interesting? Don`&apos`t forget to sign up for the event in time!</p>
        ...
        <div className="border p-2 rounded border-green-400 flex gap-4 mt-5">
          {list.map((item, i) => {
            return <Event name={item.name} img={item.img} key={i}/>
          })}
        </div>
      </div>
